...
#### Importing, cleaning, and scoring informant data ####
...
#### Regression models (informant) ####
## Bivariate relations (note order of variables)
...
pvals.self = c(.372, .063, .001, .005, .119, .010)
p.adjust(pvals.self, method = "BH") # self-antagonism, self-disinhibition, and self-total still statistically significant
